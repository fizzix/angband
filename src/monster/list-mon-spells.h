...
RSF(SHRIEK,		RST_ANNOY,	"shriek",		    0,	0, 	0,			MSG_SHRIEK,		FALSE,	100,	"makes a high-pitched",	RV(0,0,0,0),	RV(0,0,0,0),	"shrieks")
...
RSF(ARROW_1,	RST_BOLT,	"arrow",			0,	0,	GF_ARROW,	0,				FALSE,	40,		"fires an",				RV(0,1,6,0),	RV(0,0,0,0),	"fires an arrow")
RSF(ARROW_2,	RST_BOLT,	"arrow",			0,	0,	GF_ARROW,	0,				FALSE,	40,		"fires an",				RV(0,3,6,0),	RV(0,0,0,0),	"fires an arrow")
RSF(ARROW_3,	RST_BOLT,	"missile",			0,	0,	GF_ARROW,	0,				FALSE,	50,		"fires a",				RV(0,5,6,0),	RV(0,0,0,0),	"fires a missile")
RSF(ARROW_4,	RST_BOLT,	"missile",			0,	0,	GF_ARROW,	0,				FALSE,	50,		"fires a",				RV(0,7,6,0),	RV(0,0,0,0),	"fires a missile")
...
RSF(BR_TIME,	RST_BREATH,	"time",		 	  150,	6,	GF_TIME,	MSG_BR_TIME,	FALSE,	100,	"breathes",				RV(0,0,0,0),	RV(0,0,0,0),	"breathes")
RSF(BR_INER,	RST_BREATH,	"inertia",	 	  200,	6,	GF_INERTIA,	MSG_BR_INERTIA,	FALSE,	100,	"breathes",				RV(0,0,0,0),	RV(0,0,0,0),	"breathes")
RSF(BR_GRAV,	RST_BREATH,	"gravity",	 	  200,	6,	GF_GRAVITY,	MSG_BR_GRAVITY,	FALSE,	100,	"breathes",				RV(0,0,0,0),	RV(0,0,0,0),	"breathes")
...
RSF(BOULDER,	RST_BOLT,	"boulder",	   		0,	0,	GF_ARROW,	0,				FALSE,	60,		"hurls a",				RV(0,1,12,0),	RV(0,14,12,1),	"hurls a boulder")
...
RSF(MIND_BLAST,	RST_ATTACK | RST_ANNOY,"psionic energy",0,0,0,		0,				TRUE,	100,	"gazes at you with",	RV(0,8,8,0),	RV(0,0,0,0),	"focuses on your mind")
...
RSF(SCARE,      RST_ANNOY,	"scary horrors",	0,	0,	0,			MSG_CAST_FEAR,	TRUE,	100,	"conjures up",			RV(0,0,0,0),	RV(0,0,0,0),	"makes scary noises")
...
RSF(TELE_TO,    RST_ANNOY,	"come hither",		0,	0,	0,			MSG_TELEPORT,	FALSE,	100,	"commands you to",		RV(0,0,0,0),	RV(0,0,0,0),	"commands you to come hither")
RSF(TELE_AWAY,  RST_ESCAPE,	"go away",			0,	0,	0,			MSG_TELEPORT,	FALSE,	100,	"commands you to",		RV(0,0,0,0),	RV(0,0,0,0),	"commands you to go away")
RSF(TELE_LEVEL, RST_ESCAPE,	"go far away",		0,	0,	0,			MSG_TPLEVEL,	TRUE,	100,	"commands you to",		RV(0,0,0,0),	RV(0,0,0,0),	"commands you to go far away")
...
RSF(TRAPS,      RST_ANNOY,	"traps",			0,	0,	0,			MSG_CREATE_TRAP,FALSE,	100,	"cackles evilly about",	RV(0,0,0,0),	RV(0,0,0,0),	"cackles evilly")
...
RSF(S_KIN,      RST_SUMMON,	"its kin",			0,	0,	0,			MSG_SUM_MONSTER,FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_HI_DEMON, RST_SUMMON,	"major demons",		0,	0,	0,			MSG_SUM_HI_DEMON,FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_MONSTER,  RST_SUMMON,	"a companion",		0,	0,	0,			MSG_SUM_MONSTER,FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_MONSTERS, RST_SUMMON,	"some friends",		0,	0,	0,			MSG_SUM_MONSTER,FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
RSF(S_ANIMAL,   RST_SUMMON,	"animals",			0,	0,	0,			MSG_SUM_ANIMAL,	FALSE,	100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
...
RSF(S_HI_UNDEAD,RST_SUMMON,	"fiends of darkness",0,	0,	0,			MSG_SUM_HI_UNDEAD,FALSE,100,	"summons",				RV(0,0,0,0),	RV(0,0,0,0),	"mumbles")
