...
EFFECT(CURE_MIND,      FALSE,  8,	"restores 10SP, cures confusion and hallucination, removes fear and grants you temporary resistance to confusion")
EFFECT(CURE_BODY,      FALSE,  7,	"heals 30 hitpoints, cut damage, and cures stunning, poison and blindness")
...
EFFECT(CURE_FULL,      FALSE, 12,	"heals 35% of max HP (minimum 300HP), cut damage, and cures stunning, poisoning, blindness, and confusion")
EFFECT(CURE_FULL2,     FALSE, 18,	"heals 1200 hit points, cut damage, and cures stunning, poisoning, blindness, and confusion")
EFFECT(CURE_NONORLYBIG,FALSE, 21,	"heals 5000 hit points, restores experience and stats, heals cut damage, and cures stunning, poison, blindness, and confusion")
...
EFFECT(IDENTIFY2,      FALSE, 15,   "reveals magical powers of all visible items")
...
EFFECT(DRAGON_BLUE,    TRUE,   18,	"allows you to breathe lightning for 150 damage")
...
EFFECT(DRAGON_BRONZE,  TRUE,   INHIBIT_POWER,	"allows you to breathe confusion for 150 damage")
EFFECT(DRAGON_GOLD,    TRUE,   19,	"allows you to breathe sound for 150 damage")
