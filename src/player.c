...
static void adjust_level(struct player *p, bool verbose)
{
	...
	while ((p->lev < PY_MAX_LEVEL) &&
		...
		effect_simple(EF_RESTORE_STAT, "0", NULL, 2, STAT_STR, 1);
		effect_simple(EF_RESTORE_STAT, "0", NULL, 2, STAT_INT, 1);
		effect_simple(EF_RESTORE_STAT, "0", NULL, 2, STAT_WIS, 1);
		effect_simple(EF_RESTORE_STAT, "0", NULL, 2, STAT_DEX, 1);
		effect_simple(EF_RESTORE_STAT, "0", NULL, 2, STAT_CON, 1);
	}
